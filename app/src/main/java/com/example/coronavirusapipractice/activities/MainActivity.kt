package com.example.coronavirusapipractice.activities
...
import com.example.coronavirusapipractice.helpers.CountriesAdapter
...
//                    country_recycler.layoutManager = GridLayoutManager(this@MainActivity, 2)
//                    country_recycler.adapter = CountriesAdapter(response.body()!!)
                }
